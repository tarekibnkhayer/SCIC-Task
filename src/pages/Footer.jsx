...
const Footer = () => {
    return (
      <footer className="md:flex mt-10 lg:mt-24 bg-[#f1faee] space-y-6 items-center">
        ...
        <img src="https://i.imgur.com/PkDLHQB.jpg" alt="website logo" className="w-52 mx-auto"  />
        </div>
        <div className="flex-grow text-base lg:text-xl flex flex-col gap-3 ml-16 md:ml-0">
            ...
            <p className='flex items-center gap-2'><AiOutlineMail></AiOutlineMail>: tasksync@gmail.com</p>
